# Available .FUN One-Word Domains (7,856)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C856%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-7%2C856%20domains-6f42c1">
...
**Public extract:** 7,856 rows · **Live catalog:** 7,856 domains
...
- `fun.csv` — public CSV extract (7,856 rows)
- `fun.json` — public JSON extract (7,856 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,856-row public sample | 7,856 live domains                               |
...
> Unique Domains. *Available .FUN One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
