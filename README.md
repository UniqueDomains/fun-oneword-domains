# Available .FUN One-Word Domains (10,469)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-10%2C469%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **10,469 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 10,469 domains · **Median ask:** $233.27 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 10,469 live domains                        |
...
This list holds 10,469 one-word domains on the .fun TLD, spanning food, wellness, sports, and everyday phrases compressed into a single ownable string — from herbbutter.fun to keepfaith.fun. With a median ask of $233, most names in this set stay affordable enough for early-stage founders while still offering upside for investors tracking a fast-growing alternative TLD. When comparing these domains, focus on brandability, pricing versus renewal cost, and how cleanly the compressed phrase reads as a single word.

- 10,469 one-word .fun domains in this set — updated daily
- Median asking price: $233 across the entire selection
- Compound-word names like solarpower.fun and chaitea.fun
- Short, brandable strings ready to own now on .fun
...
> Unique Domains. *Available .FUN One-Word Domains*. Version 2026-07-07. Public GitHub extract for the exact Unique Domains search represented by this repository.
